...
execute as @a[tag=poison] positioned as @s run function races:races/races/druid/alchemymod

execute as @a[tag=poison] if score @s effect matches ..10 run schedule function races:races/races/druid/runeffect 1t append
